# Copied from https://raw.githubusercontent.com/deepinsight/insightface/master/web-demos/src_recognition/scrfd.py
...
class SCRFD:
    def __init__(self, model_file=None, session=None):
        ...
        if self.session is None:
            ...
            self.session = onnxruntime.InferenceSession(self.model_file, providers=['CPUExecutionProvider', 'CUDAExecutionProvider'])
        self.center_cache = {}
        self.nms_thresh = 0.4
        self.det_thresh = 0.5
        self._init_vars()
