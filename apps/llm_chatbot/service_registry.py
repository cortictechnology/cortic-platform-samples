...
@service_handle
def local_llm(task_data, device_name='', on_result=None, timeout=None, service_states={}):
  pass

@service_handle
def langchain_chat(task_data, device_name='', on_result=None, timeout=None, service_states={}):
  pass
